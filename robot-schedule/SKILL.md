...
**Do NOT feed the long values to his clipboard.** He asked whether that was
possible on 2026-09-23 and then declined it the same minute — *"no dont bother
with the copy on the clipboard"*. He keys from the table. Offering a clipboard
hand-off per field turns one readable table into a back-and-forth.
